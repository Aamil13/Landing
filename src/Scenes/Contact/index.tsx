          ...
          <div className="mt-10 justify-between gap-8 md:flex">
            ...
            >
              ...
              >
                ...
                <input
                  className={`${inputStyles} selection:bg-black `}
                  type="text"
                  placeholder="EMAIL"
                  {...register("email", {
                    required: true,
            ...
            >
              <div className="max-md:hidden w-full before:absolute before:-bottom-0 before:-right-10 before:z-[-1] md:before:content-evolvetext ">
                <img
